package com.react.framework.handler;

import cn.dev33.satoken.exception.NotLoginException;
import cn.dev33.satoken.exception.SaTokenException;
import cn.hutool.core.lang.Dict;
import com.react.framework.exception.BusinessException;
import com.react.framework.model.Response;
import com.react.utils.HttpServletRequestUtil;
...
public class GlobalExceptionHandler {
  ...
  public Response handleRRException(BusinessException e) {
    ...
    return Response.error("500", e.getCode() + "", e.getMsg());
  }
  ...
  public Response handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
    ...
    return Response.error("500", "方法参数类型不匹配");
  }
  ...
  public Response handleMissingServletRequestParameterException(
    ...
    log.info(HttpServletRequestUtil.getAllRequestInfo());
    log.error("缺少请求参数", e);
    return Response.error("500", "缺少请求参数");
  }
  ...
  public Response handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
    log.info(HttpServletRequestUtil.getAllRequestInfo());
    log.error("参数解析失败", e);
    return Response.error("500", "参数解析失败");
  }
  ...
  public Response handleValidationException(ValidationException e) {
    log.info(HttpServletRequestUtil.getAllRequestInfo());
    log.error("参数验证失败", e);
    return Response.error("500", "参数验证失败");
  }
  ...
  public Response handleHttpRequestMethodNotSupportedException(
    ...
    return Response.error("500", "不支持当前请求方法");
  }
  ...
  public Response handleHttpMediaTypeNotSupportedException(Exception e) {
    ...
    return Response.error("500", "不支持当前媒体类型");
  }
  ...
  public Response handleMaxSizeException(MaxUploadSizeExceededException e) {
    log.info(HttpServletRequestUtil.getAllRequestInfo());
    log.error(e.getMessage(), e);
    return Response.error("500", "文件太大，失败！");
  }
  ...
  public Response handleNotLoginException(NotLoginException e) {
    ...
    return Response.error("401", "未登录，或已过期，请重新登录");
  }
  ...
  public Response handleMaxSizeException(SaTokenException e) {
    log.error(
        ...
        HttpServletRequestUtil.getRequestURI(),
        HttpServletRequestUtil.getRequest().getMethod(),
        e.getMessage());
    return Response.error("403", "权限不够，拒绝访问");
  }
    ...
    e.getConstraintViolations()
        .forEach(
            (constraintViolation) -> {
              ...
              result.add(
                  Dict.create()
                      .set("field", leafNodeName)
                      .set("msg", constraintViolation.getMessage()));
            });
    return Response.error(result);
  }
  ...
  public Response handlerNoFoundException(Exception e) {
    log.error(e.getMessage(), e);
    return Response.error("404", "页面不存在，请检查路径是否正确");
  }
